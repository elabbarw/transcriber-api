...
def scrubber(transcript: str, lang: str = 'en'):
        """
    ...
    def predict(
        ...
        if diarise_audio:
            ...
            if self.diarization_pipeline is not None:
                ...
                return {
                    "PII": segmented_transcript,
                    "NOPII": scrubber("".join(segmented_transcript)),
                    "LANG": outputs['chunks'][0]['language']
                }

        print("Voila!✨ Your file has been transcribed!")
        return {
            "PII": outputs,
            "NOPII": scrubber(outputs['text']),
            "LANG": outputs['chunks'][0]['language']
        }
